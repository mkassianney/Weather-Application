    ...
    @section('content')
                <div class="flex flex-col justify-center items-center gap-12 w-full min-h-screen bg-gradient-to-br py-12">
                        <div class="flex flex-col justify-center items-center gap-4 bg-white/10 rounded-2xl shadow-lg border border-white/30 w-[80%] h-auto p-8">
                            ...
                            <div class="grid grid-cols-3">
                                <div class="flex flex-col justify-center items-center gap-4">
                                    <p class="text-white/40 text-sm">Fells Like</p>
                                ...
                                <div class="flex flex-col justify-center items-center gap-4">
                                    <p class="text-white/40 text-sm">Max/Min</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-[80%]">
                            <div class="flex justify-between bg-white/10 rounded-2xl border border-white/30 w-full h-auto p-6">
                                <div class="flex flex-col justify-center gap-2">
                                    <p class="text-white/40 text-lg">Humidity</p>
                            ...
                            <div class="flex justify-between bg-white/10 rounded-2xl border border-white/30 w-full h-auto p-6">
                                <div class="flex flex-col justify-center gap-2">
                                    <p class="text-white/40 text-lg">Wind</p>
                            ...
                            <div class="flex justify-between bg-white/10 rounded-2xl border border-white/30 w-full h-auto p-6">
                                <div class="flex flex-col justify-center gap-2">
                                    <p class="text-white/40 text-lg">Pressure</p>
                            ...
                            <div class="flex justify-between bg-white/10 rounded-2xl border border-white/30 w-full h-auto p-6">
                                <div class="flex flex-col justify-center gap-2">
                                    <p class="text-white/40 text-lg">Visibility</p>
                            ...
                            <div class="flex justify-between bg-white/10 rounded-2xl border border-white/30 w-full h-auto p-6">
                                <div class="flex flex-col justify-center gap-2">
                                    <p class="text-white/40 text-lg">Sunrise</p>
                            ...
                            <div class="flex justify-between bg-white/10 rounded-2xl border border-white/30 w-full h-auto p-6">
                                <div class="flex flex-col justify-center gap-2">
                                    <p class="text-white/40 text-lg">Sunset</p>
                        ...
                        <div class="flex justify-items-start">
                            <h2 class="text-white text-3xl font-semibold">Next Days</h2>
                        </div>
                        ...
                        <div class="grid grid-cols-5 flex-wrap w-[80%] gap-8">
                            <div class="flex flex-col justify-center items-center bg-white/10 rounded-2xl border border-white/30 w-full h-auto p-6 gap-4">
                                <p class="text-white text-lg">{{ $weather['day_one']['date'] }}</p>
                                <div class="flex justify-center items-center">
                                ...
                                <p class="text-white text-2xl font-bold">{{ $weather['day_one']['max_temp'] }}°</p>
                                <p class="text-white text-lg">{{ $weather['day_one']['min_temp'] }}°</p>
                                <p class="text-white/50 text-sm text-center">{{ $weather['day_one']['condition'] }}</p>
                            </div>

                            <div class="flex flex-col justify-center items-center bg-white/10 rounded-2xl border border-white/30 w-full h-auto p-6 gap-4">
                                <p class="text-white text-lg">{{ $weather['day_two']['date'] }}</p>
                                <div class="flex justify-center items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sun-icon lucide-sun"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/>
                                        <path d="m17.66 17.66 1.41 1.41"/>
                                        <path d="M2 12h2"/>
                                ...
                                <p class="text-white text-2xl font-bold">{{ $weather['day_two']['max_temp'] }}°</p>
                                <p class="text-white text-lg">{{ $weather['day_two']['min_temp'] }}°</p>
                                <p class="text-white/50 text-sm text-center">{{ $weather['day_two']['condition'] }}</p>
                            </div>

                            <div class="flex flex-col justify-center items-center bg-white/10 rounded-2xl border border-white/30 w-full h-auto p-6 gap-4">
                                <p class="text-white text-lg">{{ $weather['day_three']['date'] }}</p>
                                <div class="flex justify-center items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sun-icon lucide-sun"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/>
                                        <path d="m17.66 17.66 1.41 1.41"/>
                                        <path d="M2 12h2"/>
                                ...
                                <p class="text-white text-2xl font-bold">{{ $weather['day_three']['max_temp'] }}°</p>
                                <p class="text-white text-lg">{{ $weather['day_three']['min_temp'] }}°</p>
                                <p class="text-white/50 text-sm text-center">{{ $weather['day_three']['condition'] }}</p>
                            </div>

                            <div class="flex flex-col justify-center items-center bg-white/10 rounded-2xl border border-white/30 w-full h-auto p-6 gap-4">
                                <p class="text-white text-lg">{{ $weather['day_four']['date'] }}</p>
                                <div class="flex justify-center items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sun-icon lucide-sun"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/>
                                        <path d="m17.66 17.66 1.41 1.41"/>
                                        <path d="M2 12h2"/>
                                ...
                                <p class="text-white text-2xl font-bold">{{ $weather['day_four']['max_temp'] }}°</p>
                                <p class="text-white text-lg">{{ $weather['day_four']['min_temp'] }}°</p>
                                <p class="text-white/50 text-sm text-center">{{ $weather['day_four']['condition'] }}</p>
                            </div>

                            <div class="flex flex-col justify-center items-center bg-white/10 rounded-2xl border border-white/30 w-full h-auto p-6 gap-4">
                                <p class="text-white text-lg">{{ $weather['day_five']['date'] }}</p>
                                <div class="flex justify-center items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sun-icon lucide-sun"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/>
                                        <path d="m17.66 17.66 1.41 1.41"/>
                                        <path d="M2 12h2"/>
                                ...
                                <p class="text-white text-2xl font-bold">{{ $weather['day_five']['max_temp'] }}°</p>
                                <p class="text-white text-lg">{{ $weather['day_five']['min_temp'] }}°</p>
                                <p class="text-white/50 text-sm text-center">{{ $weather['day_five']['condition'] }}</p>
                            </div>
                        </div>
                    </div>
    @endsection
